      ...
      <div className="px-5 pt-4">
        ...
        <div className="bg-white rounded-3xl p-5 shadow-sm border border-gray-100 mb-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
             ...
             <div>
               <h3 className="text-sm font-bold text-gray-900 leading-tight">Prompt<br/>credits</h3>
               <p className="text-xs font-medium text-gray-500 mt-1">Earned today: <span className="text-emerald-600">+120 pts</span></p>
             </div>
          </div>
        ...
        <div className="space-y-3 mb-6">
          <OfferCard 
            ...
            pts="+50 pts" info="90m away" bg="bg-rose-50" tag="3 min left" tagColor="text-rose-600 bg-rose-100"
          />
          <OfferCard 
            ...
            pts="+30 pts" info="120m away" bg="bg-indigo-50" tag="8 min left" tagColor="text-amber-600 bg-amber-100"
          />
          <OfferCard 
            ...
            pts="+15 pts" info="40m away" bg="bg-emerald-50"
          />
        </div>
...
const OfferCard = ({ icon, title, desc, pts, info, bg, tag, tagColor }) => (
  <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 relative mt-2">
    ...
    <div className="flex gap-3">
      <div className={`w-10 h-10 shrink-0 rounded-2xl ${bg} flex items-center justify-center`}>
        {icon}
      </div>
